...
public class CustomerDAOImpl implements CustomerDAO{
    ...
    public boolean add(Customer entity) throws SQLException, ClassNotFoundException {
        return SQLUtil.execute("INSERT INTO Customer (customer_id,name, address,contact) VALUES (?,?,?,?)", entity.getCustomer_id(), entity.getName(), entity.getAddress(), entity.getContact());
    }

    @Override
    public boolean update(Customer entity) throws SQLException, ClassNotFoundException {
        return SQLUtil.execute("UPDATE Customer SET name=?, address=?, contact=? WHERE customer_id=?", entity.getName(), entity.getAddress(), entity.getContact(), entity.getCustomer_id());
    }
